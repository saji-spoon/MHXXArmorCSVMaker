...
QVariant ArmorSkillModel::headerData(int section, Qt::Orientation orientation, int role) const
{
        ...
        {
                "",
                QString::fromLocal8Bit("頭"),
                QString::fromLocal8Bit("胴"),
                QString::fromLocal8Bit("腕"),
                QString::fromLocal8Bit("腰"),
                QString::fromLocal8Bit("足")
        };
        ...
        case Qt::DisplayRole:
                ...
                {
                        return (section <= 1) ? "" : QString::fromLocal8Bit("スキル") + QString::number(section-1);
